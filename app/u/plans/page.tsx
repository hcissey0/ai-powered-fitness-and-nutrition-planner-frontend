...
function PlanSelector({ plans, selectedPlan, setSelectedPlan }: any) {
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-1 space-y-6">
        {/* Stats cards for nutrition can go here */}
      </div>
    </motion.div>
  );
}
    ...
    <div className="space-y-6">
      ...
      {selectedPlan ? (
        <Tabs defaultValue="nutrition" className="w-full">
          ...
          <TabsContent value="nutrition" className="mt-6 flex justify-center border items-center">
...
// import { WorkoutTracking, MealTracking, FitnessPlan } from "@/interfaces";
...
//   const [selectedPlan, setSelectedPlan] = useState<FitnessPlan | null>(
//     activePlan
//   );
...
//   const [selectedWorkoutDay, setSelectedWorkoutDay] = useState<number>(
//     new Date().getDay()
//   );
...
//   useEffect(() => {
//     setWaterIntake(
//       selectedPlan?.nutrition_days.find(
//         (nd) => nd.day_of_week === selectedNutritionDay
//       )?.target_water_litres || 0
//     );
...
//     () =>
//       selectedPlan?.nutrition_days.find(
//         (n) => n.day_of_week === selectedNutritionDay
//       ) || null,
//     [selectedPlan, selectedNutritionDay]
//   );
//   const currentWorkout = useMemo(
//     () =>
//       selectedPlan?.workout_days.find(
//         (w) => w.day_of_week === selectedWorkoutDay
//       ) || null,
//     [selectedPlan, selectedWorkoutDay]
//   );
...
//                                   {selectedDayStats.nutrition.totalMeals} Logged
//                                 </Badge>
//                               </CardTitle>
//                               <CardDescription>
...
//                                   of {selectedDayStats.nutrition.waterTarget}L
//                                   target
//                                 </div>
//                               </div>
//                               <Progress
...
//                                       <Badge className="">Meditation</Badge>
...
//                                   of {selectedDayStats.workout.totalToday}{" "}
//                                   exercises
//                                 </div>
//                               </div>
//                               {!currentWorkout.is_rest_day && (
